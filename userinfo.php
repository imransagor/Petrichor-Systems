...
<?php
	$user=$_SESSION['login_user'];
		...
		$sql = "SELECT * FROM userlist WHERE U_id = '$user'";
		...
		while($row = mysqli_fetch_array($result)) {
			echo " <form action=Uquery.php method=POST> ";
			  echo " <tr>";
				echo" <th>"."Name:"." </th>";
			  ...
			  echo " <tr>";
			   echo" <th>"."UserName:"." </th>";
				echo " <td>" ."<input type=text name=u_id value=" .$row['U_id'] . " </td>";		
			  echo " </tr>";
			  
			  echo " <tr>";
			   echo" <th>"."Password:"." </th>";
				echo " <td>" ."<input type=text name=u_password value=".$row['U_password'] ." </td>";
			  echo " </tr>"; 
			  
			  echo " <tr>";
			   echo" <th>"."Address:"." </th>";
				echo " <td>" ."<input type=text name=u_address value=".$row['U_address'] . " </td>";		
			  echo " </tr>";
			  
			  echo " <tr>";
			   echo" <th>"."ContactNo:"." </th>";
				echo " <td>" ."<input type=text name=u_contactNo value=".$row['U_contactNo'] . " </td>";		
			  echo " </tr>";
			  
			  echo " <tr>";
			   echo" <th>"."Email:"." </th>";
				echo " <td>"."<input type=text name=u_email value=" .$row['U_email'] . " </td>";		
			  echo " </tr>";
			  echo " <input type=hidden name=hidden value=" .$row['U_id'] ." <br>"." <br>";
